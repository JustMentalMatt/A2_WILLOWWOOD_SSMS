...
movies_img_data = Image.open("./GUI_Design/Quiz/Images/movies-quiz-bg.png")
...
sports_img_data = Image.open("./GUI_Design/Quiz/Images/sports-quiz-bg.png")
...
geography_img_data = Image.open("./GUI_Design/Quiz/Images/geography-quiz-bg.png")
