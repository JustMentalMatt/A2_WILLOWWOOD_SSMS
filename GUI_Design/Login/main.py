...
CTkButton(master=frame, text="Register", fg_color="#EEEEEE", hover_color="#c4c2c2", font=("Arial Bold", 9), text_color="#601E88", width=225).pack(anchor="w", pady=(20, 0), padx=(25, 0))
